...
#define HOMING_BUMP_DIVISOR { 2, 2, 5 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate) //JT Matching Factory
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  37.00f          // (Hz) The default dominant resonant frequency on the X axis. // JT Personal Values
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  41.36          // (Hz) The default dominant resonant frequency on the Y axis. //JT Personal Values
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.08 }    // (mm) Compression length per 1mm/s extruder speed, per extruder //JT .4 Nozzle value
  #else
    #define ADVANCE_K 0.08        // (mm) Compression length applying to all extruders // JT .4 Nozzle Value
  #endif
