...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN LED3_PIN  //JT                // Override the default pin if needed
  #define INVERT_CASE_LIGHT false             // Set true if Case Light is ON when pin is LOW
  #define CASE_LIGHT_DEFAULT_ON true          // Set default power-up state on
  #define CASE_LIGHT_DEFAULT_BRIGHTNESS 255 //JT   // Set default power-up brightness (0-255, requires PWM pin)
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  20.30          // (Hz) The default dominant resonant frequency on the X axis. // JT Personal Values
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  20.76          // (Hz) The default dominant resonant frequency on the Y axis. //JT Personal Values
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.05 }    // (mm) Compression length per 1mm/s extruder speed, per extruder //JT .4 Nozzle value
  #else
    #define ADVANCE_K 0.05        // (mm) Compression length applying to all extruders // JT .4 Nozzle Value
  #endif
  //#define ADVANCE_K_EXTRA       // Add a second linear advance constant, configurable with M900 L.
  //#define LA_DEBUG              // Print debug information to serial during operation. Disable for production use.
  //#define EXPERIMENTAL_SCURVE   // Allow S-Curve Acceleration to be used with LA.
  //#define EXPERIMENTAL_SCURVE   // Enable this option to permit S-Curve Acceleration // JT Disabling for linear advance
